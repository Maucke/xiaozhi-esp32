 ...
 */
void BOE_48_1504FN::content_show(int start, char *buf, int size, HNA_NumAni ani)
{
    if (content_inhibit_time != 0)
    {
 ...
 */
void BOE_48_1504FN::noti_show(int start, char *buf, int size, HNA_NumAni ani, int timeout)
{
 ...
 */
unsigned int BOE_48_1504FN::find_hex_code(char ch)
{
    if (ch >= ' ' && ch <= 'Z')
        return hex_codes[ch - ' '];
    else if (ch >= 'a' && ch <= 'z')
 ...
 */
void BOE_48_1504FN::charhelper(int index, uint32_t code)
{
    if (index >= 10)
        return;
 ...
 */
void BOE_48_1504FN::find_enum_code(HNA_Symbols flag, int *byteIndex, int *bitIndex)
{
 ...
 */
void BOE_48_1504FN::symbolhelper(HNA_Symbols symbol, bool is_on)
{
 ...
 */
void BOE_48_1504FN::dotshelper(Dots dot)
{
    gram[1] &= ~0xF8;
    gram[2] &= ~0xF;
 ...
 */
void BOE_48_1504FN::wavehelper(int index, int level)
{
 ...
 */
void BOE_48_1504FN::corewavehelper(int l_level, int r_level)
{
