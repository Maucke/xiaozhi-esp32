...
private:
    ...
    const unsigned int hex_codes[CHAR_COUNT][5] = {
        ...
        {0x1E, 0x29, 0x49, 0x49, 0x06}, /*"7", 55(ASCII)*/
...
public:
    ...
    /**
     * @brief Constructor that initializes an BOE_48_1504FN object using the given SPI device handle.
     *
